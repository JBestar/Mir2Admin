<%@ Page Language="C#" MasterPageFile="~/Include/AppStaff.Master" AutoEventWireup="true" CodeBehind="agency.aspx.cs" Inherits="Mir2Admin.Staff.agency" %>
...
<table class="table-content">
    <tr>
        <td >
            <asp:Label Runat="server" ID="lbl_banner" Width="120" Text="총판명 || 아이디" />
            <asp:TextBox ID="txt_search" runat="server" Width="100" />
            <asp:Button ID="BtnSearch" runat="server" Text="총판검색" />
        </td>
        <td class="td-content-right">
            <asp:Button ID="BtnRegCompany" runat="server" Text="총판등록" onclick="BtnRegAgency_Click" />
        </td>
    </tr>
</table>
            ...
            <ItemTemplate>
                <div class="div-column-modify">
                    ...
                    <asp:Button ID="BtnDelete" runat="server" Text="삭제" 
                        OnClientClick="return confirm( '총판을 삭제하시겠습니까?')"
                        CommandArgument='<%# DataBinder.Eval(Container, "DataItem.lbl_mb_fid") %>'
