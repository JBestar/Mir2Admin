<%@ Page Language="C#" MasterPageFile="~/Include/AppStaff.Master" AutoEventWireup="true" CodeBehind="employeeEdit.aspx.cs" Inherits="Mir2Admin.Staff.employeeEdit" %>
        ...
        <tr>
            <td>
                ...
                <table class="normal_box" >
                    ...
                    <tr class="tr-edit ht center">
                        <td style="text-align:left"></td>
                        <td style="text-align:left">매장아이디:</td>
                        <td style="text-align:left">
                    ...
                    <tr class="tr-edit ht center">
                        <td style="text-align:left"></td>
                        <td style="text-align:left">매장닉네임:</td>
                        <td style="text-align:left">
                    ...
                    <tr class="tr-edit ht center">
                        <td style="text-align:left"></td>
                        <td style="text-align:left">매장색깔:</td>
                        <td style="text-align:left">
                    ...
                    <tr class="tr-edit ht center">
                        ...
                        <td style="text-align:left">
                            <div>
                                <asp:CheckBox ID="ChkLuckyGold" runat="server" Text="럭키골드존" /></div>
                            <div>
                                <asp:CheckBox ID="ChkLuckyPal" runat="server" Text="럭키팔팔" /></div>
                            <div>
                                <asp:CheckBox ID="ChkCross" runat="server" Text="조합베팅" /></div>
                            <div>
                                <asp:CheckBox ID="ChkMpowerball" runat="server" Text="멀티파워볼" /></div>
                            <div>
                                <asp:CheckBox ID="ChkParadais" runat="server" Text="파라다이스" /></div>
                            <div>
                                <asp:CheckBox ID="ChkYPowerball" runat="server" Text="Y파워볼" /></div>
                        </td>
                        <td style="text-align:left"></td>
                    </tr>
                    -->
