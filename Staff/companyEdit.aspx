<%@ Page Language="C#" MasterPageFile="~/Include/AppStaff.Master" AutoEventWireup="true" CodeBehind="companyEdit.aspx.cs" Inherits="Mir2Admin.Staff.companyEdit" %>
...
<table class="adm table-edit">
		...
		<td>
            ...
            <tr class="tr-edit ht center">
				...
				<td style="text-align:left">본사아이디:</td>
			...
			<tr class="tr-edit ht center">
				<td style="text-align:left"></td>
				<td style="text-align:left">본사닉네임:</td>
				<td style="text-align:left">
			...
			<tr class="tr-edit ht center">
				<td style="text-align:left"></td>
				<td style="text-align:left">본사색깔:</td>
				<td style="text-align:left">
